...
import { initUploadArea, useFavicon, toggleIconSearch, searchIcons, toggleEmojiSearch, searchEmojis, activateCustomUploadMode } from './components/icon-picker';
...
document.getElementById('upload-custom-btn')!.addEventListener('click', activateCustomUploadMode);
