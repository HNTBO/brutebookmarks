...
export function renderApp(): void {
  ...
  app.innerHTML = `
    ...
    <div class="container">
      ...
      <footer>
        <a href="https://ko-fi.com/hntbo" target="_blank" rel="noopener noreferrer" class="footer-contact">Buy me a <img src="${kofiLogo}" alt="Ko-fi" class="kofi-logo"></a>
    ...
    <div class="mobile-toolbar">
      ...
      <div class="mobile-toolbar-btn" id="mobile-avatar-btn"><div class="clerk-user-button-mount"></div><svg class="default-avatar-overlay" viewBox="0 0 512 512" aria-hidden="true"><rect class="avatar-bg" width="512" height="512"/><rect class="avatar-shape" x="189.69" y="97.61" width="132.63" height="113.62"/><rect class="avatar-shape" x="110.55" y="225.59" width="290.89" height="188.81"/></svg></div>
        ...
        <div class="modal-body">
          ...
          <div class="settings-section">
            ...
            <div class="settings-row settings-row-actions">
              ...
              <a href="https://chromewebstore.google.com/search/brutebookmarks" target="_blank" rel="noopener noreferrer" class="btn">Install Chrome Extensions</a>
